...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="h-full bg-white border-r border-gray-200 print:hidden flex flex-col">
      <Tabs defaultValue="manual" className="flex-1 flex flex-col bg-white">
        ...
        <TabsContent value="manual" className="flex-1 overflow-y-auto m-0 bg-white">
